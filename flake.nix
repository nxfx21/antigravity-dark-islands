    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        islandsDarkExtension = pkgs.stdenv.mkDerivation {
          ...
          installPhase = ''
            mkdir -p "$out/share/antigravity/extensions/nxfx21.islands-dark"
            cp -r package.json themes "$out/share/antigravity/extensions/nxfx21.islands-dark/"
          '';

          passthru = {
            vscodeExtUniqueId = "nxfx21.islands-dark";
            vscodeExtPublisher = "nxfx21";
