...
# One-liner: curl -fsSL https://raw.githubusercontent.com/nxfx21/antigravity-dark-islands/main/bootstrap.sh | bash

echo "🏝️  Islands Dark Theme Bootstrap Installer for Antigravity"
echo "========================================================"
echo ""

REPO_URL="https://github.com/nxfx21/antigravity-dark-islands.git"
...
echo ""
echo -e "🎉 Done! Enjoy your Islands Dark theme on Antigravity!"